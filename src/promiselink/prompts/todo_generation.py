...
4. due_date_suggestion必须基于事件发生日期({event_date})推算，使用ISO 8601格式
...
8. suggested_deadline必须基于事件发生日期({event_date})推算，使用ISO 8601格式(如2026-06-25T00:00:00)
...
8. due_date_suggestion必须基于事件发生日期({event_date})推算，使用ISO 8601格式
