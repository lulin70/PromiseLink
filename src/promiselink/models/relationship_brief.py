...
class RelationshipBrief(Base):
    ...
    #       "last_interaction": {"time": str, "context": str},
    #       "interaction_freq": {"days_since_last": int, "avg_interval_days": float, "trend": str},
    #       "open_promises": {"my_promises": [...], "their_promises": [...]},
    #       "their_concerns": [{"category": str, "detail": str}],
    #       "my_contributions": [{"category": str, "detail": str}],
    #       "cooperation_signals": [{"signal": str, "confidence": float}],
    #       "risk_flags": [{"flag": str, "severity": str}],
    #       "next_actions": [{"action": str, "priority": str}],
