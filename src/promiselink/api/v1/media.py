...
from promiselink.schemas.api_responses import TTSFallbackResponse
from promiselink.services.asr_service import ASRService
from promiselink.services.event_processor import process_event_background
from promiselink.services.ocr_service import OCRService
from promiselink.services.tts_service import TTSService

logger = get_logger("promiselink.api.media")
...
async def asr_endpoint(
    ...
    try:
        ...
        raise BusinessError(str(exc), code="SERVICE_UNAVAILABLE")
