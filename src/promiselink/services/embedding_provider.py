...
logger = get_logger("promiselink.embedding_provider")
...
class EmbeddingProvider:
    ...
    async def embed(self, text: str) -> list[float]:
        ...
        If embedding_provider=api, try API first, fall back to local model.
        ...
        # Local provider: skip API, go directly to local model
