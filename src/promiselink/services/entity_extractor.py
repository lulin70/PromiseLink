...
logger = get_logger("promiselink.entity_extractor")
...
class EntityExtractor:
    ...
    CONVERSATION_TYPES = {"meeting", "call", "manual", "wechat_forward"}
    ...
    def _create_entity(
        ...
        try:
            ...
            if settings.strict_properties_validation:
                raise
            logger.warning(
                "entity_properties_validation_failed",
                person_name=person.name,
                error=str(validation_err)[:200],
            )
