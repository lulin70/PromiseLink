...
logger = get_logger("eventlink.data_source_adapter")
...
class RawEvent:
    ...
    This is the universal input format that the EventLink pipeline accepts.
...
class DataSourceAdapter(ABC):
    ...
    EventLink pipeline can process.
...
class WeChatAdapter(DataSourceAdapter):
    ...
    - User must explicitly share content to EventLink
