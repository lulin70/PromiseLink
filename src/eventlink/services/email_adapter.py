...
from eventlink.services.data_source_adapter import DataSourceAdapter, RawEvent

logger = get_logger("eventlink.email_adapter")
...
class EmailAdapter(DataSourceAdapter):
    ...
    them into RawEvent objects for the EventLink pipeline.
