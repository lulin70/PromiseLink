...
<p align="center">
  ...
  <a href="https://github.com/lulin70/PromiseLink/releases"><img src="https://img.shields.io/badge/version-v0.9.8-blue?style=flat-square" alt="Version"></a>
  <br/>
...
**v0.9.8 直接下载**（双击安装，无需 Python 环境）：

- **macOS**: [PromiseLink-0.9.8-mac.dmg](https://github.com/lulin70/PromiseLink/releases/download/v0.9.8/PromiseLink-0.9.8-mac.dmg)（Apple Silicon / Intel，~82 MB）
- **Windows**: [PromiseLink-0.9.8-windows.exe](https://github.com/lulin70/PromiseLink/releases/download/v0.9.8/PromiseLink-0.9.8-windows.exe)（Windows 10/11 64-bit，~42 MB）
