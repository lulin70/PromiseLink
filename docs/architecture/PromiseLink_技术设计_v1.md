...
> **日期**: 2026-06-17
> **对应PRD**: v5.2
> **口径说明（2026-09-21 补）**：此处 `v5.2` 指**本文档写作时所依据的 PRD 基线**，是历史事实，**不随 PRD 升版而改写**（否则"技术设计对应哪一版 PRD"将无法追溯）。其后 PRD 的增量（v5.3~v5.9）均以**附录式增补**形式落在本文档对应章节，未整体重新基线化 —— 即本文档对 PRD v5.9 的覆盖是**部分**的，差异以 PRD 为准。README 的"文档版本"行写的是**当前 PRD 版本 + 本文档版本**（v5.9 / v3.2），两者不是同一个口径。
> **架构师**: CarryMem团队
