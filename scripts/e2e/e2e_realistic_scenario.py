...
EVENTS = [
    ...
    },
    {
        ...
        "raw_text": Path("./docs/internal/PromiseLink_李总反馈_PM+架构师.md").read_text(encoding="utf-8"),
        "date": "2026-06-01",
    ...
    },
    {
        ...
        "raw_text": Path("./docs/internal/PromiseLink_李总反馈v2_PM+架构师.md").read_text(encoding="utf-8"),
        "date": "2026-06-02",
...
async def main():
    _print("=" * 72)
    _print("  PromiseLink PoC — 真实会议记录测试（每个Event展示完整数据变换链）")
